...
namespace GameLauncher
{
    ...
    public partial class MainWindow : Window
    {
            ...
            set
            {
                ...
                switch (_status)
                {
                    case LauncherStatus.ready:
                        PlayTekhael.Content = "Play";
                        break;
                    case LauncherStatus.failed:
                        PlayTekhael.Content = "Update Failed - Retry";
                        break;
                    case LauncherStatus.downloadingGame:
                        PlayTekhael.Content = "Downloading Game";
                        break;
                    case LauncherStatus.downloadingUpdate:
                        PlayTekhael.Content = "Downloading Update";
                        break;
                    default:
                        break;
                }
        ...
        public MainWindow()
        {
            ...
            gameExe = Path.Combine(rootPath, "Build", "Tekhael.exe");
        ...
        private void PlayTekhael_Click(object sender, RoutedEventArgs e)
        {
